function loadContent(page) {
    ...
    if (page === "index.html") {
        // Limpa o conteúdo da seção para evitar duplicação
        ...
        `;
        return; // Encerra a função para evitar o carregamento do conteúdo duplicado
    }

    // Remove qualquer CSS existente que tenha sido carregado dinamicamente
